 ...
 * @author Filip Gulan
 */
public class EnglishUpercaseOneToOneDiagonalStructuralTest {
    ...
    private static final String NNET_NAME = "OneToOne_Cross_5_Max_Index_Unique_English_Uppercase_Points_Structural.nnet";
