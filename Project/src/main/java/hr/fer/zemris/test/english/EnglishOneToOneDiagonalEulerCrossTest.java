 ...
 * @author Filip Gulan
 */
public class EnglishOneToOneDiagonalEulerCrossTest {
    ...
    private static final String NNET_NAME = "OneToOne_Cross_5_Max_Index_Unique_English_Euler_All_Points.nnet";
    ...
    private static DataSet loadDataSet(String path) {
        ...
        for (InputImage image : images) {
            ...
            IFeatureVector vector = new DiagonalEulerCrossFeatureVector(image);
