 ...
 * @author Filip Gulan
 */
public class OneToOneHVTest {

    private static final int INPUT_LAYER = 45;
    ...
    private static final String NNET_NAME = "OneToOne_HV_Cro_Test_All.nnet";
    private static final String LEARNING_PATH = "/Users/Filip/FER/Zavrsni rad/Obrada2/";
    private static final String TEST_PATH = "/Users/Filip/FER/Zavrsni rad/Test2/";
    ...
    private static DataSet loadDataSet(String path) {
        ...
        for (InputImage image : images) {
            ...
            IFeatureVector vector = new VerticalHorizontalProjection(image);
