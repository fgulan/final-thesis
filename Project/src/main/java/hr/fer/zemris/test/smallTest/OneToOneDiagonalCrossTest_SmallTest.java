 ...
 * @author Filip Gulan
 */
public class OneToOneDiagonalCrossTest_SmallTest {
    ...
    private static final String NNET_NAME = "OneToOne_Cross_5_Max_Index_Unique_All_Points_Croatian_small_Test.nnet";
