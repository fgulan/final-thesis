 ...
 * @author Filip Gulan
 */
public class EnglishOneToOneMatrixTest {

    private static final int INPUT_LAYER = 900;
    ...
    private static final String NNET_NAME = "OneToOne_Matrix_Unique_English_All_Points.nnet";
    ...
    private static DataSet loadDataSet(String path) {
        ...
        for (InputImage image : images) {
            ...
            IFeatureVector vector = new MatrixFeatureVector(image);
