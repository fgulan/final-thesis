 ...
 * @author Filip Gulan
 */
public class OneToOneNonUniqueDiagonalTest {

    private static final int INPUT_LAYER = 48;
    private static final int OUTPUT_LAYER = 63;
    private static final double MOMENTUM = 0.77;
    private static final double LEARINING_RATE = 0.012;
    private static final String NNET_NAME = "OneToOne_5_Max_Index_Non_Unique.nnet";
    ...
    private static DataSet loadDataSet(String path) {
        ...
        for (InputImage image : images) {
            ...
            output[LetterMapper.mapLetter(image.getSymbol())] = 1;
