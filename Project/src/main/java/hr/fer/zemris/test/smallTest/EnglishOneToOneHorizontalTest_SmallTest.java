 ...
 * @author Filip Gulan
 */
public class EnglishOneToOneHorizontalTest_SmallTest {
    ...
    private static final String NNET_NAME = "Horizontal_5_Max_Index_Unique_English_All_Points_samll_Test.nnet";
