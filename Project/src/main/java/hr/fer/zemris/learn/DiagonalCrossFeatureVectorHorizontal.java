 ...
 * @author Filip Gulan
 */
public class DiagonalCrossFeatureVectorHorizontal extends AbstractFeatureVector {

    private static final int ZONE_SIZE = 5;

    private InputImage inputImage;

    public DiagonalCrossFeatureVectorHorizontal(int inputSize, int outputSize) {
        super(inputSize, outputSize);
    }

    public DiagonalCrossFeatureVectorHorizontal(int inputSize, double[] output) {
        super(inputSize, output);
    }

    public DiagonalCrossFeatureVectorHorizontal(double[] input, double[] output) {
        super(input, output);
    }

    public DiagonalCrossFeatureVectorHorizontal(List<Double> input, List<Double> output) {
        super(input, output);
    }

    public DiagonalCrossFeatureVectorHorizontal(InputImage inputImage) {
        super(65, inputImage.getBinarySymbol());
