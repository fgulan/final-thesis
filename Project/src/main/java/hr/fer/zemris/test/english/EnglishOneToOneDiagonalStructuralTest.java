...
import hr.fer.zemris.learn.DiagonalStructuralFeatureVector;
 ...
 * @author Filip Gulan
 */
public class EnglishOneToOneDiagonalStructuralTest {

    private static final int INPUT_LAYER = 66;
    ...
    private static final String NNET_NAME = "OneToOne_Cross_5_Max_Index_Unique_English_Points_Structural.nnet";
    ...
    private static DataSet loadDataSet(String path) {
        ...
        for (InputImage image : images) {
            ...
            IFeatureVector vector = new DiagonalStructuralFeatureVector(image);
