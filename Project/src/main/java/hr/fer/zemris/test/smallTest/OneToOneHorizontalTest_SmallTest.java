 ...
 * @author Filip Gulan
 */
public class OneToOneHorizontalTest_SmallTest {

    private static final int INPUT_LAYER = 90;
    private static final int OUTPUT_LAYER = 32;
    private static final double MOMENTUM = 0.02;
    private static final double LEARINING_RATE = 0.01;
    private static final String NNET_NAME = "OneToOne_Jorizontal_5_Max_Index_Unique_All_Points_Croatian_small_Test.nnet";
    ...
    private static CroatianCharacterMapper mapper = new CroatianCharacterMapper();
