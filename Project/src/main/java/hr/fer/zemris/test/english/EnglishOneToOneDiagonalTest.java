package hr.fer.zemris.test.english;
...
import hr.fer.zemris.learn.DiagonalFeatureVector;
 ...
 * @author Filip Gulan
 */
public class EnglishOneToOneDiagonalTest {

    private static final int INPUT_LAYER = 48;
    private static final int OUTPUT_LAYER = 27;
    private static final double MOMENTUM = 0.77;
    private static final double LEARINING_RATE = 0.01;
    private static final String NNET_NAME = "OneToOne_5_Max_Index_Unique_English.nnet";
    ...
    private static DataSet loadDataSet(String path) {
        ...
        for (InputImage image : images) {
            ...
            IFeatureVector vector = new DiagonalFeatureVector(image);
    ...
    private static List<InputImage> loadInputImages(String stringPath) {
        ...
        try {
            ...
            for (Path path : images) {
                ...
                inputImages.add(new InputImage(binImage, path.getFileName().toString().charAt(0)));
            }
        } catch (Exception e) {
