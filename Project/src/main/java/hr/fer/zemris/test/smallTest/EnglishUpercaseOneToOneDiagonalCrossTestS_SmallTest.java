 ...
 * @author Filip Gulan
 */
public class EnglishUpercaseOneToOneDiagonalCrossTestS_SmallTest {
    ...
    private static final String NNET_NAME = "OneToOne_Cross_5_Max_Index_Unique_English_Uppercase_Points_small_test.nnet";
