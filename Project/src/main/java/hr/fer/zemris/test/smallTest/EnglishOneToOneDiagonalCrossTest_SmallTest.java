 ...
 * @author Filip Gulan
 */
public class EnglishOneToOneDiagonalCrossTest_SmallTest {
    ...
    private static final String NNET_NAME = "OneToOne_Cross_5_Max_Index_Unique_English_All_Points_samll_Test.nnet";
